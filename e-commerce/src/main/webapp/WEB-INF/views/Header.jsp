...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-Left">
      <a class="navbar-brand" href="./"><img alt="" class="img-responsive" src="${pageContext.request.contextPath}/resources/images/download.jpg" style="margin:0; width:120px; height:60px;"></a>
    </div>
