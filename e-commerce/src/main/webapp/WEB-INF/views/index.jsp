            ...
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item item1 active">
                        <div class="fill" style=" background-color:#bbff00;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                    <img src="${pageContext.request.contextPath}/resources/images/puppy1.jpg" alt="Puppy" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">
                                    <h2>Golden retriever</h2>
                                    <p> These are domesticated mammals, not natural wild animals. They were originally bred from wolves.</p>
                                    <p> They have been bred by humans for a long time, and were the first animals ever to be domesticated</p>
                    ...
                    <div class="item item2">
                        <div class="fill" style="background-color:#7fc2f4;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                    <img src="${pageContext.request.contextPath}/resources/images/catin.jpg" alt="Cat" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">

                                    <h2>Cats</h2>
                                    <p>Different types of cats are available with different colours</p>
                                    <p>which are friendly in nature</p>
                                    <p>Cats with kittens</p>
                        ...
                        <div class="fill" style="background-color:#b33f4a;">
                            <div class="inner-content">
                                <div class="col-md-6">
                                    ...
                                    <div class="carousel-img">
                                        <img src="${pageContext.request.contextPath}/resources/images/birdin.jpg" alt="Bird" class="img img-responsive" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-left">
                                    <div class="carousel-desc">
                                        ...
                                        <h2>Birds</h2>
                                        <p>which are very friendly in nature</p>
                                        <p>Birds are a group of endothermic vertebrates, characterised by feathers, </p>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
