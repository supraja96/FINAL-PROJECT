...
public class ProductController {
	...
	public ModelAndView addP(@RequestParam("name") String name, @RequestParam("price") int price, @RequestParam("stock") int stock,
	    ...
	    i.setImg(img);
		 String filepath ="C:/Users/prashanth/workspace/e-commerce/src/main/webapp/resources/Productimage/" + file.getOriginalFilename();
		 try {
		 ...
		 String img1=file1.getOriginalFilename();
		    i.setImg1(img1);
			 String filepath1 ="C:/Users/prashanth/workspace/e-commerce/src/main/webapp/resources/Productimage/" + file1.getOriginalFilename();
			 try {
			 ...
			 String img2=file2.getOriginalFilename();
			    i.setImg2(img2);
				 String filepath2 ="C:/Users/prashanth/workspace/e-commerce/src/main/webapp/resources/Productimage/" + file2.getOriginalFilename();
				 try {
				 ...
				 String img3=file3.getOriginalFilename();
				    i.setImg3(img3);
					 String filepath3 ="C:/Users/prashanth/workspace/e-commerce/src/main/webapp/resources/Productimage/" + file3.getOriginalFilename();
					 try {
